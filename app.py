...
def login():
    ...
    if not st.session_state.logged:
        with st.container(horizontal_alignment="center"):
            ...
            if con.button("Ingresar", type="primary"):
                if check_login(user, pwd):
                    ...
                    con.error("Usuario o contraseña incorrectos")
...
if login():
    ...
    if not df.empty:
        st.title("Reporte de :primary[Gestion para Test de Competencia] - :violet[Axion]")
        # columna a filtrar
